...
impl<'a> Transport<'a> for TransportLocal   {
    ...
    fn register(&self, _buses: &std::ops::Range<rmb::Bus>, _handler: fn(&'a mut msgmgr::MsgMgr, rmb::Bus, Box<dyn rmb::Msg + 'static>)-> Result<String, String>) -> Result<String, String> {
        Ok("Success".to_string())
    }
